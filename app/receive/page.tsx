      ...
      <div className="container mx-auto px-6 pt-32 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight">
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Receive</span>{" "}
            Payments
          </h1>

          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
            Connect your wallet to start receiving cross-chain payments.{" "}
            <span className="font-semibold text-foreground">Fast, Secure, Reliable.</span>
          </p>

          {/* Receive Payment Interface Placeholder */}
          <div className="bg-background/50 backdrop-blur-sm border border-border rounded-2xl p-8 shadow-xl">
            <div className="text-center">
              <h2 className="text-2xl font-semibold text-foreground mb-4">
                Add receive payment interface here
              </h2>
              <p className="text-muted-foreground">
                Connect your wallet above to get started with receiving cross-chain payments.
              </p>
            </div>
          </div>
        </div>
